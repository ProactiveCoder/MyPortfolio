        ...
        <div className={style.box1}>
          ...
          <ul>
            <p className={style.skillpara}>
              Java <img className={style.logoimg} src={java} alt="" />
            </p>
            <p className={style.skillpara}>
              C++ <img className={style.logoimg} src={cplush} alt="" />
            </p>
            <p className={style.skillpara}>
              C <img className={style.logoimg} src={c} alt="" />
            </p>
            <p className={style.skillpara}>
              Python <img className={style.logoimg} src={python} alt="" />
            </p>
            <p className={style.skillpara}>
              HTML <img className={style.logoimg} src={html} alt="" />
            </p>
            <p className={style.skillpara}>
              CSS <img className={style.logoimg} src={css} alt="" />
            </p>
            <p className={style.skillpara}>
              JavaScript <img className={style.logoimg} src={js} alt="" />
            </p>
            <p className={style.skillpara}>
              React <img className={style.logoimg} src={react} alt="" />
            </p>
            <p className={style.skillpara}>
              Express Js{" "}
